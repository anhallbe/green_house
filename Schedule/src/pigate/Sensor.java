...
//		if(PiGate.debug) System.out.println("Schedule: executing sensorvalue..");
		...
		try {
			...
			if(PiGate.debug) System.out.println("From sensor: " + line);
//			value = Integer.parseInt(line);
			value = Integer.parseInt(line);
			timeOfLastUpdate = System.currentTimeMillis();
			if(PiGate.debug) System.out.println("Sensor update success, value: " + value);
			return value;
		}
		catch (Exception e) {
//			if(PiGate.debug) System.out.println("Schedule: sensorvalue was failed..");
			if(PiGate.debug) System.out.println("Sensor update failed, value: " + -9999);
			return  -9999;
		}	
	}
